...
async function performScan() {
    for (const country in scanQueue) {
        ...
        for (let idx = 0; idx < total; idx++) {
            ...
            console.log(`→ got ${roadClosures.objects.length} roadClosures ` +
